...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Easily generate permitted attributes for ActiveController::StrongParameters}
  spec.description   = %q{Gem to easily generate permitted attributes for ActiveController::StrongParameters}
